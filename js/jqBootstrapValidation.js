        ...
        return this.each(function(){
          ...
          if (settings.options.sniffHtml) {
            ...
            if ($this.attr("type") !== undefined && $this.attr("type").toLowerCase() === "phone") {
              ...
              if ($this.data("validationPhineMessage")) {
			...
			number: {
				...
				message: "Must be a number<!-- data-validator-number-message to override -->"
                        ...
                        phone: {
                                name: "Phone",
                                type: "regex",
                                regex: "([+-]?\\\d+([\\\s-\\\d]+)?([\\\s-]?(ext.)?[0-9]+)?)?",
                                message: "Must be a phone number.  (eg: +886912345678, 0912-345-678, 02 34567890 ext.9)<!-- data-validator-number-message to override -->"
                        },
			integer: {
				name: "Integer",
				type: "regex",
